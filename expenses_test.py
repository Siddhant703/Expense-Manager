...
class Expenses_Test(unittest.TestCase):
    ...
    def test_get_expense(self):
        ...
        self.assertAlmostEqual(825.00, expenses_manager.get_expense(self.expenses, "rent").amount)
        self.assertEqual(None, expenses_manager.get_expense(self.expenses, "sports"))
    ...
    def test_add_expense(self):
        ...
        expenses_manager.add_expense(self.expenses, "rent", 10)
        expenses_manager.add_expense(self.expenses, "food", 15)
        self.assertAlmostEqual(835.00, self.expenses.get("rent").amount )
        self.assertAlmostEqual(20.00, self.expenses.get("food").amount)
    ...
    def test_deduct_expense(self):
        ...
        with self.assertRaises(RuntimeError):
            expenses_manager.deduct_expense(self.expenses, "rent", 850)

        self.assertAlmostEqual(None, expenses_manager.deduct_expense(self.expenses, "sports", 2))
    ...
    def test_update_expense(self):
        ...
        expenses_manager.update_expense(self.expenses, "family", 15.00)
        self.assertAlmostEqual(15.00, expenses_manager.get_expense(self.expenses, "family").amount)

        self.assertAlmostEqual(None, expenses_manager.update_expense(self.expenses, "sports", 2))
    ...
    def test_sort_expenses(self):
        ...
        expense_type_sorted_expenses = [('rent', 825.0),
                                        ('music', 324.0),
                                        ('entertainment', 135.62),
                                        ('clothes', 45.0),
                                        ('family', 32.45),
